def main():
    ...
    name2name.add_argument("-from_format", choices = ["mol2", "pdb", "gaff_mol2"], required = True, help = "the format of the file which is needed to change from")
    name2name.add_argument("-from_file", required = True, help = "the name of the file which is needed to change from")
    name2name.add_argument("-to_format", choices = ["mol2", "pdb", "gaff_mol2"], required = True, help = "the format of the file which is needed to change to")
    name2name.add_argument("-to_file", required = True, help = "the name of the file which is needed to change to")
    name2name.add_argument("-out_format", choices = ["mol2", "pdb"], required = True, help = "the format of the output file")
    name2name.add_argument("-out_file", required = True, help = "the name of the output file")
    ...
    mol2rfe.add_argument("-residuetype1", help = "molecule mutated from by an Xponge ResidueType mol2 file")
    mol2rfe.add_argument("-residuetype0", nargs = "*", default = [], help = "molecule mutated from by an Xponge ResidueType mol2 file")
    mol2rfe.add_argument("-residue", type = int, default = 0, help = "the residue index of the molecule to mutate")
    mol2rfe.add_argument("-lambda_numbers", type = int, default = 20, help = "the number of lambda groups - 1, default 20 for 0, 0.05, 0.10, 0.15..., 1.0")
    mol2rfe.add_argument("-prebalance_step", type = int, default = 50000, help = "the numbers of step to do the prebalance simulation")
    mol2rfe.add_argument("-balance_step", type = int, default = 500000, help = "the numbers of step to do the balance simulation")
    mol2rfe.add_argument("-barostat", default = "andersen_barostat", help = "the barostat used for the simulation")
    mol2rfe.add_argument("-thermostat", default = "middle_langevin", help = "the thermostat used for the simulation")
    mol2rfe.add_argument("-method", default = "TI", choices = ["TI"], help = "the method to calculate the free energy")
    mol2rfe.add_argument("-protein_ff", default = "ff14SB", choices = ["ff14SB", "ff19SB"], help = "the protein force field")
    ...
    mol2rfe.add_argument("-temp", default = "TMP", help = "the temporary file name prefix")
    mol2rfe_2 = mol2rfe.add_mutually_exclusive_group(required = True)
    mol2rfe_2.add_argument("-assignment2", help = "molecule mutated to by an Xponge assignment mol2 file")
    mol2rfe_2.add_argument("-name2", help = "molecule mutated to by the name of the molecule")
    mol2rfe_2.add_argument("-smiles2", help = "molecule mutated to by the smiles of the molecule")
    mol2rfe_2.add_argument("-residuetype2", help = "molecule mutated to by an Xponge ResidueType mol2 file")
